...
MERGE INTO itens_venda (id, preco_unitario, quantidade, produto_id, venda_id) VALUES
(1, 29.90, 2, 1, 2),
(2, 35.00, 1, 10, 2),
(3, 20.31, 1, 7, 2),
(4, 95.00, 2, 7, 7),
...
MERGE INTO movimentos_estoque (id, motivo, data, quantidade, tipo, produto_id, usuario_id) VALUES
-- VENDA 2
(2, 'Venda ID: 2', '2025-11-06 13:36:03', -2, 'SAIDA_VENDA', 1, 2),
(3, 'Venda ID: 2', '2025-11-06 13:36:03', -1, 'SAIDA_VENDA', 10, 2),
(4, 'Venda ID: 2', '2025-11-06 13:36:03', -1, 'SAIDA_VENDA', 7, 2),

-- VENDA 7
(5, 'Venda ID: 7', '2025-11-07 10:21:15', -2, 'SAIDA_VENDA', 7, 2),
(6, 'Venda ID: 7', '2025-11-07 10:21:15', -1, 'SAIDA_VENDA', 10, 2),
(7, 'Venda ID: 7', '2025-11-07 10:21:15', -1, 'SAIDA_VENDA', 1, 2),

-- VENDA 3
(8, 'Venda ID: 3', '2025-11-07 17:45:54', -1, 'SAIDA_VENDA', 1, 2),
(9, 'Venda ID: 3', '2025-11-07 17:45:54', -1, 'SAIDA_VENDA', 10, 2),
(10, 'Venda ID: 3', '2025-11-07 17:45:54', -1, 'SAIDA_VENDA', 7, 2),

-- VENDA 4
(11, 'Venda ID: 4', '2025-11-08 09:15:12', -1, 'SAIDA_VENDA', 5, 2),
(12, 'Venda ID: 4', '2025-11-08 09:15:12', -1, 'SAIDA_VENDA', 7, 2),
(13, 'Venda ID: 4', '2025-11-08 09:15:12', -1, 'SAIDA_VENDA', 1, 2),

-- VENDA 5
(14, 'Venda ID: 5', '2025-11-08 18:04:33', -1, 'SAIDA_VENDA', 7, 2),
(15, 'Venda ID: 5', '2025-11-08 18:04:33', -1, 'SAIDA_VENDA', 10, 2);
